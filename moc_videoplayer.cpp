...
QT_MOC_LITERAL(3, 29, 13) // "sig_GetRFrame"

    },
    "VideoPlayer\0sig_GetOneFrame\0\0sig_GetRFrame"
};
...
void VideoPlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sig_GetRFrame((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (VideoPlayer::*)(QImage );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoPlayer::sig_GetRFrame)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void VideoPlayer::sig_GetRFrame(QImage _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
